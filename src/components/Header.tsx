    ...
    >
      <div className="max-w-(--max-w-content) mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-5">
          ...
          <a
            href="/boka/"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-semibold rounded-lg hover:bg-primary/90 transition-all duration-300 shadow-[0_0_20px_rgba(94,195,214,0.2)] hover:shadow-[0_0_25px_rgba(94,195,214,0.4)] hover:-translate-y-0.5"
          >
            Boka tid
          </a>
        </div>
        ...
        <button
          className="lg:hidden p-2 -mr-1 rounded-lg text-muted-foreground hover:text-foreground hover:bg-secondary transition-all"
