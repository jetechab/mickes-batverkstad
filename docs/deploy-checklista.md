...
Koden är förberedd men vilande: utan nycklarna fungerar formulären exakt
som tidigare, utan robotkontroll. Aktiveras först när klienten vill,
hela guiden finns i `docs/turnstile-aktivering.md`.
